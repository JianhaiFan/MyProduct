...
/**
 * @author: 范建海
 * @createTime: 2016/10/25 11:41
 * @className:  HanziUtil
 * @description: 处理中文相关的工具类
 * @changed by:
 */
public class HanziUtil {
    ...
    public static String getChineseSpell(String strText) {
        ...
        for (int i = 0; i < strText.length(); i++) {
            ...
            LogUtil.e("vChar: " + vChar);
            LogUtil.e("vChar: " + (int)vChar);
            LogUtil.e("strChineseFirstPY: " + strChineseFirstPY.charAt(8055));
            // 若是字母则直接输出
            if ((vChar >= 'a' && vChar <= 'z')
                    || (vChar >= 'A' && vChar <= 'Z'))
                myStr.append(vChar);
